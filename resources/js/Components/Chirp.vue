    ...
    <div class="p-6 flex space-x-2">
        ...
        <div class="flex-1">
            ...
            <div class="mt-2">
                ...
                <button @click.prevent="toggleLike(chirp.id)" type="submit" class="text-gray-600 hover:text-gray-800 left-0">
                    <svg xmlns="http://www.w3.org/2000/svg" :fill="like.value ? ' ' : 'none'" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                ...
                <button type="submit" class="text-gray-600 hover:text-gray-800">
                    <svg xmlns="http://www.w3.org/2000/svg" :fill="comments ? ' ' : 'none'" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
